...
/// ADAU1466 + CS42448 ("파란보드") 어댑터 — 스켈레톤
///
...
///   - _pramAddr(channelIndex, bandIndex) → ADAU1466 PRAM 주소
...
class Adau1466Adapter implements DspAdapter {
  ...
  Future<void> writeBiquad(int channelIndex, int bandIndex, BiquadCoeffs coeffs) async {
    // TODO: ADAU1466 PRAM 주소 계산 + 5.27 고정소수점 변환 + ICP5 BLE 프레임
    // ADAU1466: 5.27 포맷 (ADAU1701의 5.23과 다름)
    throw UnimplementedError('ADAU1466 PRAM 주소맵 미확정 — SigmaStudio export 후 구현');
  }

  @override
  Future<void> writeCrossover(int channelIndex, CrossoverConfig config) async {
    // TODO: LR4 크로스오버 Biquad 계수 → writeBiquad 호출
    throw UnimplementedError('ADAU1466 크로스오버 미구현');
  }

  @override
  Future<void> writeDelay(int channelIndex, double delayMs) async {
    // TODO: ADAU1466 딜레이 셀 주소 기입
    throw UnimplementedError('ADAU1466 딜레이 미구현');
  }

  @override
  Future<void> writeGain(int channelIndex, double gainDb) async {
    // TODO: ADAU1466 게인 셀 주소 기입
    throw UnimplementedError('ADAU1466 게인 미구현');
  }

  @override
  Future<void> writeSubsonicFilter(int channelIndex, double freqHz) async {
    // TODO: 서브소닉 HPF Biquad → writeBiquad 호출
    throw UnimplementedError('ADAU1466 서브소닉 필터 미구현');
  }
