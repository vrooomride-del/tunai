...
class TastePreset {
  ...
  const TastePreset({required this.id, required this.label, required this.description, required this.bands});
}

const kTastePresets = [
  TastePreset(
    id: 'warm', label: 'Warm', description: '따뜻하고 부드러운 소리',
    bands: [
  ...
  TastePreset(
    id: 'neutral', label: 'Neutral', description: '원음에 가까운 플랫한 소리',
    bands: [],
  ),
  TastePreset(
    id: 'studio', label: 'Studio', description: '모니터링에 최적화',
    bands: [
  ...
  TastePreset(
    id: 'vocal', label: 'Vocal', description: '보컬이 선명하게',
    bands: [
  ...
  TastePreset(
    id: 'movie', label: 'Movie', description: '저음 강조, 영화/게임용',
    bands: [
  ...
  TastePreset(
    id: 'bright', label: 'Bright', description: '고음 강조, 선명한 소리',
    bands: [
