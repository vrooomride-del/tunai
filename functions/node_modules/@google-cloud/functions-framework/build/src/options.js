...
exports.parseOptions = exports.helpText = exports.logExecutionIdSupported = exports.requiredNodeJsVersionForLogExecutionID = exports.OptionsError = void 0;
...
exports.logExecutionIdSupported = Number(process.versions.node.split('.', 1)[0]) >= 13;
const ExecutionIdOption = new ConfigurableOption('log-execution-id', 'LOG_EXECUTION_ID', false, x => {
    ...
    if (isTrue && !exports.logExecutionIdSupported) {
